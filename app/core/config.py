...
class Settings(BaseSettings):
    ...
    DOUYIN_SPI_SKIP_SIGN_VERIFY: bool = False
    """仅本地联调：跳过抖音 SPI 回调验签（生产勿开）。"""
    DOUYIN_WEBHOOK_SKIP_SIGN_VERIFY: bool = False
    """仅本地联调：跳过抖音 Webhook 事件验签（verify_webhook 不受影响；生产勿开）。"""
