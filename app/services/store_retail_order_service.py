...
from app.services.store_config_service import get_store_base_delivery_fee_yuan, get_store_config
...
def _notify_store_retail_order_paid(db: Session, order: StoreRetailOrder) -> None:
    from app.services.admin_system_notification_service import create_store_retail_order_paid_notification
...
def member_cancel_store_retail_order(db: Session, *, member_id: int, order_id: int) -> str:
    ...
    if pay == "已支付":
        ...
        from app.services.store_retail_order_admin_service import admin_wechat_refund_store_retail_order
