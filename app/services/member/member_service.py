...
from app.services.shared.store_config_service import ensure_app_settings_row
...
def patch_member_profile(
    ...
    *,
    ...
    if set_daily_meal_units and daily_meal_units is not None:
        from app.services.member.leave import guard_miniprogram_self_service_requires_balance
        from app.services.member.member_daily_meal_units_service import set_member_daily_meal_units_change
    ...
    if set_daily_meal_units and units_change_mode != "unchanged" and (
        ...
        record_member_operation(
            ...
            summary=summary,
            before={
                "daily_meal_units": prev_snapshot["daily_meal_units"],
                "daily_meal_units_pending": prev_snapshot["daily_meal_units_pending"],
            },
            after={
                "daily_meal_units": new_snapshot["daily_meal_units"],
                **after_units,
            },
