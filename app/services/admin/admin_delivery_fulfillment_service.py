...
from app.services.delivery.courier_service import eligible_members_for_delivery, eligible_members_for_store_pickup
...
def admin_mark_subscription_fulfilled(
    ...
    *,
    ...
    if renew is not None:
        ...
        try_send_renew_remind_after_balance_change(
            db, renew[0], balance_before=renew[1], meal_period=period
        )
