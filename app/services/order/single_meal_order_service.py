...
from app.services.admin.admin_system_notification_service import create_single_meal_order_paid_notification
from app.services.shared.store_config_service import get_store_base_delivery_fee_yuan, load_store_coordinates_for_sorting
...
def _region_name_map_from_joined_row(region_row: DeliveryRegion | None) -> dict[int, str]:
    from app.services.member.member_address_service import UNASSIGNED_DELIVERY_AREA
